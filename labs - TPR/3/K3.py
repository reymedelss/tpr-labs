...
if sumA > sumB and sumA > sumC:
    print(Style.BRIGHT + Back.WHITE + Fore.BLUE + "Переможцем за методом Борда є кандидат А з рахунком", sumA, "очків")
elif sumB > sumA and sumB > sumC:
    print(Style.BRIGHT + Back.WHITE + Fore.BLUE + "Переможцем за методом Борда є кандидат Б з рахунком", sumB, "очків")
elif sumC > sumA and sumC > sumB:
    print(Style.BRIGHT + Back.WHITE + Fore.BLUE + "Переможцем за методом Борда є кандидат C з рахунком", sumC, "очків")
else:
    print(Style.BRIGHT + Back.WHITE + Fore.RED + "Переможця за методом Борда не знайдено.")
...
if ab > ba:
    ...
    print(Style.BRIGHT + Back.WHITE + Fore.RED + "Переможця за методом Кондорсе не знайдено.")
...
if ab > ba and ac > ca:
    print(Style.BRIGHT + Back.WHITE + Fore.BLUE +"Переможцем за методом Кондорсе є кандидат А")
elif bc > cb and ba > ab:
    print(Style.BRIGHT + Back.WHITE + Fore.BLUE +"Переможцем за методом Кондорсе є кандидат Б")
elif ca > ac and cb > bc:
    print(Style.BRIGHT + Back.WHITE + Fore.BLUE +"Переможцем за методом Кондорсе є кандидат С")
else:
    print(Style.BRIGHT + Back.WHITE + Fore.RED + "Переможця за методом Кондорсе не знайдено.")